...
We calculated the first eigenvector numerically and plotted it against the analytical eigenvector with $N=100$. The plot is displayed in \hyperref[fig:IV:a:1]{Figure 1}. In order for them to be scaled similarly we chose to normalize both. As shown in the legend text of the plot in \hyperref[fig:IV:a:1]{Figure 1}, the eigenvalues belonging to the eigenvector found numerically and analytically are the same to the 10th digit.
