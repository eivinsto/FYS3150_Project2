...
\caption{Figure displaying first eigenvector calculated numerically in the buckling beam problem plotted together with the analytical result. Both the analytical and numerical solution have been normalized so they are scaled similarly.}
\end{figure}
